...
| Automated tests | Partial | 32 pytest and 7 BATS tests cover backend/dashboard behavior, vLLM/llama.cpp provider parsing/configuration, image pinning, restart policy, read-only cache mounting, AMD SMI mounting, and shell safety. Broader browser/matrix/security coverage remains. |
