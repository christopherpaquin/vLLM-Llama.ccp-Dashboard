...
| Automated tests | Partial | 20 pytest and 6 BATS tests cover backend behavior plus image pinning, restart policy, isolation from vLLM, AMD SMI mounting, and shell safety. Broader matrix/security coverage remains. |
